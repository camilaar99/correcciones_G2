...
const controller = {
	...
	store: (req, res) => {
		...
		if (errors.isEmpty()) {
			...
			res.render('product-create-form',{errores:errors.array(), old: req.body})
		}
	...
	edit: (req, res) => {
		...
		res.render('product-edit-form', { id_producto, 'productToEdit': elemento2, title: elemento2.name })
	},
	...
	update: (req, res) => {
		...
		if (req.file) {
			...
			let itemEditado = { id: id_producto, ...req.body, image: req.file.filename }
